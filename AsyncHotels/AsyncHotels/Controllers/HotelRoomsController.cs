...
namespace AsyncHotels.Controllers
{
    public class HotelRoomsController : Controller
    {
        ...
        {
            var asyncDbContext = _context.HotelRooms.Include(h => h.Hotel).Include(h => h.Room);
        ...
        {
            ViewData["HotelID"] = new SelectList(_context.Hotels, "ID", "City");
        ...
        public async Task<IActionResult> Create([Bind("HotelID,RoomNumber,RoomID,Rate,PetFriendly")] HotelRoom hotelRoom)
        {
            ...
            ViewData["HotelID"] = new SelectList(_context.Hotels, "ID", "City", hotelRoom.HotelID);
